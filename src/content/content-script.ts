...
function detectReckognyze(): boolean {
  // Check for common Reckognyze indicators
...
function showPanel(): void {
  if (panelIframe) {
    ...
    chrome.runtime.sendMessage({ type: 'SET_PANEL_VISIBLE', visible: true });
  }
}
...
function hidePanel(): void {
  if (panelIframe) {
    ...
    // Notify the service worker
    chrome.runtime.sendMessage({ type: 'SET_PANEL_VISIBLE', visible: false });
  }
}
